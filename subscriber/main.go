...
func main() {
	...
	flag.StringVar(&URL, "s", "nats://nats_a:4222", "The nats server URLs (separated by comma)")
	flag.StringVar(&URL, "server", "nats://nats_a:4222", "The nats server URLs (separated by comma)")
