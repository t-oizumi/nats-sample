...
func main() {
	...
	flag.StringVar(&URL, "s", "nats://nats_a:4222,nats://nats_a:4223", "The nats server URLs (separated by comma)")
	flag.StringVar(&URL, "server", "nats://nats_a:4222,nats://nats_a:4223", "The nats server URLs (separated by comma)")
	flag.StringVar(&clusterID, "c", "test-cluster", "The NATS Streaming cluster ID")
	flag.StringVar(&clusterID, "cluster", "test-cluster", "The NATS Streaming cluster ID")
	flag.StringVar(&clientID, "id", "", "The NATS Streaming client ID to connect with")
	flag.StringVar(&clientID, "clientid", "subscribeOne", "The NATS Streaming client ID to connect with")
